...
import { Plus, Search, Truck, AlertCircle, CheckCircle } from "lucide-react";
import { useState } from "react";
import Link from "next/link";

const labOrders = [
  { id: "LAB-1342", patient: "Emily Johnson", patientId: "P-1002", item: "PFM Crown (Tooth #16)", labName: "Elite Dental Labs", dateSent: "Mar 15, 2024", dateDue: "Mar 25, 2024", status: "In Progress", cost: "$250" },
  { id: "LAB-1341", patient: "Michael Chen", patientId: "P-1089", item: "Zirconia Bridge (11-13)", labName: "Precision DentLab", dateSent: "Mar 10, 2024", dateDue: "Mar 20, 2024", status: "Received", cost: "$600" },
  { id: "LAB-1340", patient: "Sarah Miller", patientId: "P-1452", item: "Night Guard", labName: "Elite Dental Labs", dateSent: "Mar 05, 2024", dateDue: "Mar 15, 2024", status: "Delivered", cost: "$150" },
  ...
  return (
    <div className="p-6 md:p-8 space-y-6 animate-fade-in-up">
      ...
      <div className="grid gap-6 md:grid-cols-4">
        {[
          { label: "Total Active Cases", value: "3", icon: Truck, color: "text-blue-600", bg: "bg-blue-100" },
          { label: "Due This Week", value: "2", icon: AlertCircle, color: "text-amber-600", bg: "bg-amber-100" },
          { label: "Received (To Deliver)", value: "1", icon: CheckCircle, color: "text-emerald-600", bg: "bg-emerald-100" },
          { label: "Total Monthly Cost", value: "$3,450", icon: Truck, color: "text-purple-600", bg: "bg-purple-100" },
        ].map((stat, i) => (
          ...
          <TableBody>
            {filteredOrders.map((order) => (
              <TableRow key={order.id} className="border-b-gray-50 hover:bg-purple-50/30 transition-colors group">
                ...
                <TableCell className="font-semibold text-gray-900">{order.cost}</TableCell>
