...
-- DropIndex
DROP INDEX IF EXISTS "payments_tenant_id_patient_id_idx";

-- AlterTable for invoice_items
ALTER TABLE "invoice_items" DROP COLUMN IF EXISTS "price",
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "clinic_memberships_tenant_id_idx" ON "clinic_memberships"("tenant_id");
CREATE INDEX IF NOT EXISTS "clinic_memberships_user_id_idx" ON "clinic_memberships"("user_id");
CREATE INDEX IF NOT EXISTS "clinic_memberships_tenant_id_is_active_idx" ON "clinic_memberships"("tenant_id", "is_active");
CREATE UNIQUE INDEX IF NOT EXISTS "clinic_memberships_tenant_id_user_id_key" ON "clinic_memberships"("tenant_id", "user_id");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "invitations_token_key" ON "invitations"("token");
CREATE INDEX IF NOT EXISTS "invitations_token_idx" ON "invitations"("token");
CREATE INDEX IF NOT EXISTS "invitations_tenant_id_email_idx" ON "invitations"("tenant_id", "email");
CREATE INDEX IF NOT EXISTS "invitations_expires_at_idx" ON "invitations"("expires_at");

-- CreateIndex for payments
CREATE INDEX IF NOT EXISTS "payments_tenant_id_paid_at_idx" ON "payments"("tenant_id", "paid_at");

-- Create Partial Unique Index for invitations
CREATE UNIQUE INDEX IF NOT EXISTS invitations_tenant_email_pending ON invitations(tenant_id, email) WHERE accepted_at IS NULL;
